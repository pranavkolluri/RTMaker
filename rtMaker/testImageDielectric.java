...
public class testImageDielectric {
    ...
    public static void world_initializer() {
        ...
        world.addObjects(new Sphere(new vec3(-1.0, 0.0, -1.0), -0.4, leftMat));
    ...
    public static Camera cam = new Camera(90, aspect_ratio);
    ...
    public static void makeImage() {
        ...
        File outFile = join(CWD, "picture10.ppm");
