...
public class testImageCamera {
    private static double aspect_ratio = 16.0/9.0;
    private static int im_width = 100;
    ...
    public static void world_initializer() {
        ...
        Materials centerMat = new Lambertian(new vec3(0.1, 0.2, 0.5));
        Materials leftMat = new Dielectric(1.5);
        Materials rightMat = new Metal(new vec3(0.8, 0.6, 0.2), 0.0);
        ...
        world.addObjects(new Sphere(new vec3(-1.0, 0.0, -1.0), 0.5, leftMat));
        world.addObjects(new Sphere(new vec3(-1.0, 0.0, -1.0), -0.45, leftMat));
        world.addObjects(new Sphere(new vec3(1.0, 0.0, -1.0), 0.5, rightMat));
    }

    public static Camera cam = new Camera(20, aspect_ratio,
            new vec3(-2.0, 2.0, 1.0), new vec3(0.0, 0.0, -1.0),
    ...
    public static void makeImage() {
        ...
        File outFile = join(CWD, "picture11.ppm");
