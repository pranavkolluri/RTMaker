...
public class testImageMetals {
    ...
    public static void world_initializer() {
        ...
        Materials leftMat = new Metal(new vec3(0.8, 0.8, 0.8), 0.3);
        Materials rightMat = new Metal(new vec3(0.8, 0.6, 0.2), 1.0);
    ...
    public static void makeImage() {
        ...
        File outFile = join(CWD, "picture9.ppm");
